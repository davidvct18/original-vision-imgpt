...
const openai = new OpenAI({ apiKey: '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' });
    ...
    const messages = [
        {
            ...
            Once you are on a URL, analize the contents and decide the brand voice, identity, unique selling point, features, etc. Incorporate the website's logo to enhance brand recognition. You will answer with a very specific prompt for an image generator. The prompt will have to create an ad creative for Facebook Ads. The image has to be photo-realistic and extremely high-quality, attention grabbing and align with the design of the webpage you are crawling. 
